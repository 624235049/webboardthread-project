<header class="app-header">
   <a class="app-header__logo" href="#">SKRU ​App</a>
   ...
   <ul class="app-nav">
      ...
      <li class="dropdown">
         ...
         <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="<?php echo ROOT_PROJECT; ?>/administrator/logout.php"><i class="fa fa-sign-out fa-lg"></i> ออกจากระบบ</a></li>
         </ul>
      </li>
   </ul>
</header>
